...
class RecordDB:
  ...
  def populate_dc_locs(self):
    ...
    session.add(Location(name='Katahdin', lat=45.9044, lon=-68.9216))
    session.add(Location(name='Chimney Pond', lat=45.916096, lon=-68.91118))
    session.add(Location(name='Roaring Brook', lat=45.919794, lon=-68.857595))
